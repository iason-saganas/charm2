...
import numpy as np
import gzip
from charm2.helpers import read_data_union, read_data_pantheon, read_data_des
...
def read_data_des_unordered():
    ...
    """
    print("\nReading DESY5 data...")
    filename = "raw_data/DES-SN5YR_HD.csv"
    ...
    filename = "raw_data/DES-SN5YR-STAT+SYS.txt.gz"
